              ...
              <table className="w-full">
                <thead>
                  <tr className="bg-gray-50 border-b border-gray-200">
                    ...
                    <th className="px-6 py-4 text-left text-xs font-semibold text-gray-700 uppercase">Prochain RDV</th>
                  </tr>
                </thead>
      ...
      {selectedChild && (
        <ChildDetailsModal
          ...
          onUpdate={(updatedChild: ChildUI) => {
            // Mise à jour de l'enfant dans la liste
            const updatedChildren = children.map(c => 
              c.id === updatedChild.id ? updatedChild : c
            );
            // Si vous utilisez un état parent pour gérer les enfants, vous devrez peut-être le mettre à jour ici
            // par exemple : setChildren(updatedChildren);
          }}
        />
      )}
    </div>
