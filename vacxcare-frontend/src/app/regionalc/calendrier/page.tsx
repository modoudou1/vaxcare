...
export default function RegionalCalendrierPage() {
      ...
      <div className="animate-fadeIn">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600">
                Consultez le calendrier officiel des vaccinations recommandées
              </p>
            </div>
            <button
              onClick={handleDownloadPdf}
              className="px-6 py-2.5 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-all flex items-center gap-2 shadow-sm"
            >
          ...
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed mt-2">
                🌍 En tant que <strong>responsable régional</strong>, consultez ce calendrier pour superviser 
                et coordonner les activités de vaccination dans votre région. Partagez-le avec vos agents de santé.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-6 bg-green-50 border border-green-200 rounded-lg p-4">
          <p className="text-green-800 text-sm">
            ...
            Pour toute question ou proposition de modification, veuillez contacter le niveau national.
          </p>
        </div>
      </div>
    </DashboardLayout>
